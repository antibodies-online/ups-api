...
/**
 * PushToImageRepositoryRequestRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PushToImageRepositoryRequestRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PushToImageRepositoryRequest_Request';
    ...
    protected static $openAPITypes = [
        ...
        'sub_version' => 'string',
        'transaction_reference' => '\AntibodiesOnline\UpsApi\Paperless\Model\RequestTransactionReference'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['request_option']) && (mb_strlen($this->container['request_option']) > 1)) {
            $invalidProperties[] = "invalid value for 'request_option', the character length must be smaller than or equal to 1.";
        }
     ...
     * Sets request_option
     *
     * @param string|null $request_option Enables the user to specify optional processing. Currently, there is no optional process in Paperless Document API.  N/A
     *
     * @return self
     */
    public function setRequestOption($request_option)
    {
        ...
        if ((mb_strlen($request_option) > 1)) {
            throw new \InvalidArgumentException('invalid length for $request_option when calling PushToImageRepositoryRequestRequest., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($request_option) < 1)) {
            throw new \InvalidArgumentException('invalid length for $request_option when calling PushToImageRepositoryRequestRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets sub_version
     *
     * @param string|null $sub_version Not Used.
     *
     * @return self
     */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Paperless\Model\RequestTransactionReference|null
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Paperless\Model\RequestTransactionReference|null $transaction_reference transaction_reference
     *
     * @return self
     */
