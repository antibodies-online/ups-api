...
class UploadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UploadRequest';
    ...
    protected static $openAPITypes = [
        'request' => '\AntibodiesOnline\UpsApi\Paperless\Model\UploadRequestRequest',
        'shipper_number' => 'string',
        'user_created_form' => '\AntibodiesOnline\UpsApi\Paperless\Model\UploadRequestUserCreatedForm[]'
    ];
    ...
    */
     ...
     * Gets request
     *
     * @return \AntibodiesOnline\UpsApi\Paperless\Model\UploadRequestRequest
     */
     ...
     * Sets request
     *
     * @param \AntibodiesOnline\UpsApi\Paperless\Model\UploadRequestRequest $request request
     *
     * @return self
     */
    ...
    public function setShipperNumber($shipper_number)
    {
        ...
        if ((mb_strlen($shipper_number) > 6)) {
            throw new \InvalidArgumentException('invalid length for $shipper_number when calling UploadRequest., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($shipper_number) < 6)) {
            throw new \InvalidArgumentException('invalid length for $shipper_number when calling UploadRequest., must be bigger than or equal to 6.');
        }
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Paperless\Model\UploadRequestUserCreatedForm[]
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Paperless\Model\UploadRequestUserCreatedForm[] $user_created_form user_created_form
     *
     * @return self
     */
