 ...
 */
class DeleteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteRequest';
    ...
    protected static $openAPITypes = [
        'request' => '\AntibodiesOnline\UpsApi\Paperless\Model\DeleteRequestRequest',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['document_id']) > 26)) {
            $invalidProperties[] = "invalid value for 'document_id', the character length must be smaller than or equal to 26.";
        }

        if ((mb_strlen($this->container['document_id']) < 26)) {
            $invalidProperties[] = "invalid value for 'document_id', the character length must be bigger than or equal to 26.";
        }
     ...
     * Gets request
     *
     * @return \AntibodiesOnline\UpsApi\Paperless\Model\DeleteRequestRequest
     */
     ...
     * Sets request
     *
     * @param \AntibodiesOnline\UpsApi\Paperless\Model\DeleteRequestRequest $request request
     *
     * @return self
     */
    ...
    public function setShipperNumber($shipper_number)
    {
        ...
        if ((mb_strlen($shipper_number) > 6)) {
            throw new \InvalidArgumentException('invalid length for $shipper_number when calling DeleteRequest., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($shipper_number) < 6)) {
            throw new \InvalidArgumentException('invalid length for $shipper_number when calling DeleteRequest., must be bigger than or equal to 6.');
        }
    ...
    public function setDocumentId($document_id)
    {
        ...
        if ((mb_strlen($document_id) > 26)) {
            throw new \InvalidArgumentException('invalid length for $document_id when calling DeleteRequest., must be smaller than or equal to 26.');
        }
        if ((mb_strlen($document_id) < 26)) {
            throw new \InvalidArgumentException('invalid length for $document_id when calling DeleteRequest., must be bigger than or equal to 26.');
        }
