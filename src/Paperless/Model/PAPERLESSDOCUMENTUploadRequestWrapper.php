 ...
 */
class PAPERLESSDOCUMENTUploadRequestWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAPERLESSDOCUMENTUploadRequestWrapper';
    ...
    protected static $openAPITypes = [
        'upload_request' => '\AntibodiesOnline\UpsApi\Paperless\Model\UploadRequest'
    ];
    ...
    {
        $this->setIfExists('upload_request', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets upload_request
     *
     * @return \AntibodiesOnline\UpsApi\Paperless\Model\UploadRequest
     */
     ...
     * Sets upload_request
     *
     * @param \AntibodiesOnline\UpsApi\Paperless\Model\UploadRequest $upload_request upload_request
     *
     * @return self
     */
    public function setUploadRequest($upload_request)
    {
        if (is_null($upload_request)) {
            throw new \InvalidArgumentException('non-nullable upload_request cannot be null');
        }
