 ...
 */
class DeleteRequestRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteRequest_Request';
    ...
    */
    ...
    public function setRequestOption($request_option)
    {
        ...
        if ((mb_strlen($request_option) > 1)) {
            throw new \InvalidArgumentException('invalid length for $request_option when calling DeleteRequestRequest., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($request_option) < 1)) {
            throw new \InvalidArgumentException('invalid length for $request_option when calling DeleteRequestRequest., must be bigger than or equal to 1.');
        }
