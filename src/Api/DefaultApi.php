...
namespace AntibodiesOnline\UpsApi\Api;
...
use AntibodiesOnline\UpsApi\HeaderSelector;
...
/**
     ...
     * @param  \AntibodiesOnline\UpsApi\Rating\RATERequestWrapper $rate_request_wrapper Generate sample code for popular API requests by selecting an example below. To view a full sample request and response, first click \&quot;Authorize\&quot; and enter your application credentials, then populate the required parameters above and click \&quot;Try it out\&quot;. (required)
     ...
     *
     * @throws \AntibodiesOnline\UpsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AntibodiesOnline\UpsApi\Rating\RATEResponseWrapper
     */
     ...
     * @throws \AntibodiesOnline\UpsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AntibodiesOnline\UpsApi\Rating\RATEResponseWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function rateWithHttpInfo($version, $requestoption, $rate_request_wrapper, $trans_id = null, $transaction_src = 'testing', $additionalinfo = null, string $contentType = self::contentTypes['rate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AntibodiesOnline\UpsApi\Rating\RATEResponseWrapper' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\AntibodiesOnline\UpsApi\Rating\RATEResponseWrapper' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AntibodiesOnline\UpsApi\Rating\RATEResponseWrapper', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\AntibodiesOnline\UpsApi\Rating\RATEResponseWrapper';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AntibodiesOnline\UpsApi\Rating\RATEResponseWrapper',
