    ...
    */
    ...
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 11)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling ShipmentServiceOptionsAccessPointCOD., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($monetary_value) < 2)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling ShipmentServiceOptionsAccessPointCOD., must be bigger than or equal to 2.');
        }
