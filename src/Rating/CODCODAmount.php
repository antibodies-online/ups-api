    ...
    */
    ...
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 8)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling CODCODAmount., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($monetary_value) < 8)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling CODCODAmount., must be bigger than or equal to 8.');
        }
