 ...
 */
class PackagePackagingType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Package_PackagingType';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $code when calling PackagePackagingType., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $code when calling PackagePackagingType., must be bigger than or equal to 2.');
        }
     ...
     * Sets description
     *
     * @param string|null $description A text description of the code for the UPS packaging type associated with the shipment.  Length is not validated.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 35)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PackagePackagingType., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PackagePackagingType., must be bigger than or equal to 1.');
        }
