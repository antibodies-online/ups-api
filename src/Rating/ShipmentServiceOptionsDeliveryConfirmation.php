...
class ShipmentServiceOptionsDeliveryConfirmation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets dcis_type
     *
     * @param string $dcis_type Type of delivery confirmation.  Valid values: 1 - Delivery Confirmation Signature Required 2 - Delivery Confirmation Adult Signature Required
     *
     * @return self
     */
