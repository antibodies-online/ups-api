 ...
 */
class ShipmentServiceOptionsReturnService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentServiceOptions_ReturnService';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ShipmentServiceOptionsReturnService., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ShipmentServiceOptionsReturnService., must be bigger than or equal to 1.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Description for type of Return Service.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 50)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ShipmentServiceOptionsReturnService., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ShipmentServiceOptionsReturnService., must be bigger than or equal to 1.');
        }
