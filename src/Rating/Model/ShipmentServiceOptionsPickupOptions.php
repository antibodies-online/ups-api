 ...
 */
class ShipmentServiceOptionsPickupOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentServiceOptions_PickupOptions';
    ...
    protected static array $openAPINullables = [
        'lift_gate_at_pickup_indicator' => false,
    ...
    {
        $this->setIfExists('lift_gate_at_pickup_indicator', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $lift_gate_at_pickup_indicator The presence of the tag LiftGatePickupRequiredIndicator indicates that the shipment requires a lift gate for pickup.
     *
     * @return self
     */
    public function setLiftGateAtPickupIndicator($lift_gate_at_pickup_indicator)
    {
        if (is_null($lift_gate_at_pickup_indicator)) {
            throw new \InvalidArgumentException('non-nullable lift_gate_at_pickup_indicator cannot be null');
        }
     ...
     *
     * @param string|null $hold_for_pickup_indicator The presence of the tag HoldForPickupIndicator indicates that the user opted to hold the shipment at UPS location for pickup.
     *
     * @return self
     */
