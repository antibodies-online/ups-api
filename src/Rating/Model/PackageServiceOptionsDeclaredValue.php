...
class PackageServiceOptionsDeclaredValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value The monetary value for the declared value amount associated with the package.  Max value of 5,000 USD for Local and 50,000 USD for Remote. Absolute maximum value is 21474836.47
     *
     * @return self
     */
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 8)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling PackageServiceOptionsDeclaredValue., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($monetary_value) < 8)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling PackageServiceOptionsDeclaredValue., must be bigger than or equal to 8.');
        }
