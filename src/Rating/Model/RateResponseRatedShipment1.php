...
/**
 * RateResponseRatedShipment1 Class Doc Comment
 *
 * @category Class
 * @package  AntibodiesOnline\UpsApi\Rating
 * @author   OpenAPI Generator team
 ...
 */
class RateResponseRatedShipment1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RateResponse_RatedShipment_1';
    ...
    protected static $openAPITypes = [
        'disclaimer' => '\AntibodiesOnline\UpsApi\Rating\Model\RateResponseRatedShipmentDisclaimer',
        'service' => '\AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentService',
        'rate_chart' => 'string',
        'rated_shipment_alert' => '\AntibodiesOnline\UpsApi\Rating\Model\RateResponseRatedShipmentRatedShipmentAlert',
        'billable_weight_calculation_method' => 'string',
        'rating_method' => 'string',
        'billing_weight' => '\AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentBillingWeight',
        'transportation_charges' => '\AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentTransportationCharges',
        'base_service_charge' => '\AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentBaseServiceCharge',
        'itemized_charges' => '\AntibodiesOnline\UpsApi\Rating\Model\RateResponseRatedShipmentItemizedCharges',
        'frs_shipment_data' => '\AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentFRSShipmentData',
        'service_options_charges' => '\AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentServiceOptionsCharges',
        'tax_charges' => '\AntibodiesOnline\UpsApi\Rating\Model\RateResponseRatedShipmentTaxCharges',
        'total_charges' => '\AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentTotalCharges',
        'total_charges_with_taxes' => '\AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentTotalChargesWithTaxes',
        'negotiated_rate_charges' => '\AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentNegotiatedRateCharges',
        'rated_package' => '\AntibodiesOnline\UpsApi\Rating\Model\RateResponseRatedShipmentRatedPackage',
        'time_in_transit' => '\AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentTimeInTransit',
    ...
    */
     ...
     * Gets disclaimer
     *
     * @return \AntibodiesOnline\UpsApi\Rating\Model\RateResponseRatedShipmentDisclaimer|null
     */
     ...
     * Sets disclaimer
     *
     * @param \AntibodiesOnline\UpsApi\Rating\Model\RateResponseRatedShipmentDisclaimer|null $disclaimer disclaimer
     *
     * @return self
     */
     ...
     * Gets service
     *
     * @return \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentService
     */
     ...
     * Sets service
     *
     * @param \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentService $service service
     *
     * @return self
     */
    ...
    public function setRateChart($rate_chart)
    {
        ...
        if ((mb_strlen($rate_chart) > 1)) {
            throw new \InvalidArgumentException('invalid length for $rate_chart when calling RateResponseRatedShipment1., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($rate_chart) < 1)) {
            throw new \InvalidArgumentException('invalid length for $rate_chart when calling RateResponseRatedShipment1., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Rating\Model\RateResponseRatedShipmentRatedShipmentAlert|null
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Rating\Model\RateResponseRatedShipmentRatedShipmentAlert|null $rated_shipment_alert rated_shipment_alert
     *
     * @return self
     */
    ...
    public function setBillableWeightCalculationMethod($billable_weight_calculation_method)
    {
        ...
        if ((mb_strlen($billable_weight_calculation_method) > 2)) {
            throw new \InvalidArgumentException('invalid length for $billable_weight_calculation_method when calling RateResponseRatedShipment1., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($billable_weight_calculation_method) < 2)) {
            throw new \InvalidArgumentException('invalid length for $billable_weight_calculation_method when calling RateResponseRatedShipment1., must be bigger than or equal to 2.');
        }
    ...
    public function setRatingMethod($rating_method)
    {
        ...
        if ((mb_strlen($rating_method) > 2)) {
            throw new \InvalidArgumentException('invalid length for $rating_method when calling RateResponseRatedShipment1., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($rating_method) < 2)) {
            throw new \InvalidArgumentException('invalid length for $rating_method when calling RateResponseRatedShipment1., must be bigger than or equal to 2.');
        }
     ...
     * Gets billing_weight
     *
     * @return \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentBillingWeight
     */
     ...
     * Sets billing_weight
     *
     * @param \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentBillingWeight $billing_weight billing_weight
     *
     * @return self
     */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentTransportationCharges
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentTransportationCharges $transportation_charges transportation_charges
     *
     * @return self
     */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentBaseServiceCharge|null
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentBaseServiceCharge|null $base_service_charge base_service_charge
     *
     * @return self
     */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Rating\Model\RateResponseRatedShipmentItemizedCharges|null
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Rating\Model\RateResponseRatedShipmentItemizedCharges|null $itemized_charges itemized_charges
     *
     * @return self
     */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentFRSShipmentData|null
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentFRSShipmentData|null $frs_shipment_data frs_shipment_data
     *
     * @return self
     */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentServiceOptionsCharges
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentServiceOptionsCharges $service_options_charges service_options_charges
     *
     * @return self
     */
     ...
     * Gets tax_charges
     *
     * @return \AntibodiesOnline\UpsApi\Rating\Model\RateResponseRatedShipmentTaxCharges|null
     */
     ...
     * Sets tax_charges
     *
     * @param \AntibodiesOnline\UpsApi\Rating\Model\RateResponseRatedShipmentTaxCharges|null $tax_charges tax_charges
     *
     * @return self
     */
     ...
     * Gets total_charges
     *
     * @return \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentTotalCharges
     */
     ...
     * Sets total_charges
     *
     * @param \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentTotalCharges $total_charges total_charges
     *
     * @return self
     */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentTotalChargesWithTaxes|null
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentTotalChargesWithTaxes|null $total_charges_with_taxes total_charges_with_taxes
     *
     * @return self
     */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentNegotiatedRateCharges|null
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentNegotiatedRateCharges|null $negotiated_rate_charges negotiated_rate_charges
     *
     * @return self
     */
     ...
     * Gets rated_package
     *
     * @return \AntibodiesOnline\UpsApi\Rating\Model\RateResponseRatedShipmentRatedPackage
     */
     ...
     * Sets rated_package
     *
     * @param \AntibodiesOnline\UpsApi\Rating\Model\RateResponseRatedShipmentRatedPackage $rated_package rated_package
     *
     * @return self
     */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentTimeInTransit|null
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Rating\Model\RatedShipmentTimeInTransit|null $time_in_transit time_in_transit
     *
     * @return self
     */
