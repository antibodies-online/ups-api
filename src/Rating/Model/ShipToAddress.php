    ...
    */
    ...
    public function setStateProvinceCode($state_province_code)
    {
        ...
        if ((mb_strlen($state_province_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state_province_code when calling ShipToAddress., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($state_province_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $state_province_code when calling ShipToAddress., must be bigger than or equal to 2.');
        }
