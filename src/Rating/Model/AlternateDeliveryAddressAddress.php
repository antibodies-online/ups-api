 ...
 */
class AlternateDeliveryAddressAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlternateDeliveryAddress_Address';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('po_box_indicator', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['state_province_code']) && (mb_strlen($this->container['state_province_code']) > 2)) {
            $invalidProperties[] = "invalid value for 'state_province_code', the character length must be smaller than or equal to 2.";
        }

        if (!is_null($this->container['state_province_code']) && (mb_strlen($this->container['state_province_code']) < 2)) {
            $invalidProperties[] = "invalid value for 'state_province_code', the character length must be bigger than or equal to 2.";
        }
     ...
     * Sets city
     *
     * @param string|null $city UPS Access Point city.
     *
     * @return self
     */
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 30)) {
            throw new \InvalidArgumentException('invalid length for $city when calling AlternateDeliveryAddressAddress., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling AlternateDeliveryAddressAddress., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $state_province_code UPS Access Point State or Province code.
     *
     * @return self
     */
    public function setStateProvinceCode($state_province_code)
    {
        ...
        if ((mb_strlen($state_province_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state_province_code when calling AlternateDeliveryAddressAddress., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($state_province_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $state_province_code when calling AlternateDeliveryAddressAddress., must be bigger than or equal to 2.');
        }
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code Postal Code for UPS accounts billing address.  Postal Code  may be present when the FRS Payment Information type = 02 and type = 03.
     *
     * @return self
     */
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 9)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling AlternateDeliveryAddressAddress., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($postal_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling AlternateDeliveryAddressAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling AlternateDeliveryAddressAddress., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling AlternateDeliveryAddressAddress., must be bigger than or equal to 2.');
        }
     ...
     *
     * @param string|null $residential_address_indicator Presence/Absence Indicator. Any value inside is ignored.This field is a flag to indicate if the Alternate Delivery location is a residential location. True if ResidentialAddressIndicator tag exists.  For future use.
     *
     * @return self
     */
     ...
     *
     * @param string|null $po_box_indicator Presence/Absence Indicator. Any value inside is ignored.This field is a flag to indicate if the Alternate Delivery location is a PO box location. True if POBoxIndicator tag exists; false otherwise.  Not valid with Shipment Indication Types:01 Hold for Pickup at UPS Access Point02 UPS Access Point Delivery
     *
     * @return self
     */
    public function setPoBoxIndicator($po_box_indicator)
    {
        if (is_null($po_box_indicator)) {
            throw new \InvalidArgumentException('non-nullable po_box_indicator cannot be null');
        }
