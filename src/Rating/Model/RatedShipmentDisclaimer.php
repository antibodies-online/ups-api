 ...
 */
class RatedShipmentDisclaimer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RatedShipment_Disclaimer';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $code when calling RatedShipmentDisclaimer., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $code when calling RatedShipmentDisclaimer., must be bigger than or equal to 2.');
        }
