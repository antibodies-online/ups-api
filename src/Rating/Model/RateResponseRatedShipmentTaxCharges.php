<?php
/**
 * RateResponseRatedShipmentTaxCharges
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RateResponseRatedShipmentTaxCharges Class Doc Comment
 *
 * @category Class
 * @package  AntibodiesOnline\UpsApi\Rating
 * @author   OpenAPI Generator team
 ...
 */
class RateResponseRatedShipmentTaxCharges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RateResponse_RatedShipment_TaxCharges';
    ...
    */
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 9)) {
            throw new \InvalidArgumentException('invalid length for $type when calling RateResponseRatedShipmentTaxCharges., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling RateResponseRatedShipmentTaxCharges., must be bigger than or equal to 1.');
        }
    ...
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 19)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling RateResponseRatedShipmentTaxCharges., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($monetary_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling RateResponseRatedShipmentTaxCharges., must be bigger than or equal to 1.');
        }
