 ...
 */
class BillReceiverAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillReceiver_Address';
    ...
    */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The postal code for the UPS account's pickup address. The pickup postal code was entered in the UPS system when the account was set-up.
     *
     * @return self
     */
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 9)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling BillReceiverAddress., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($postal_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling BillReceiverAddress., must be bigger than or equal to 1.');
        }
