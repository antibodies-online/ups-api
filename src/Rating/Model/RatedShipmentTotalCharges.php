...
/**
 * RatedShipmentTotalCharges Class Doc Comment
 *
 * @category Class
 ...
 */
class RatedShipmentTotalCharges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RatedShipment_TotalCharges';
    ...
    */
     ...
     * Sets currency_code
     *
     * @param string $currency_code The IATA currency code associated with the total charges for the package.
     *
     * @return self
     */
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling RatedShipmentTotalCharges., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling RatedShipmentTotalCharges., must be bigger than or equal to 3.');
        }
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value The value for the total charges associated with the package.
     *
     * @return self
     */
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 19)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling RatedShipmentTotalCharges., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($monetary_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling RatedShipmentTotalCharges., must be bigger than or equal to 1.');
        }
