...
/**
 * BillThirdPartyAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class BillThirdPartyAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillThirdParty_Address';
    ...
    */
     ...
     * Sets address_line
     *
     * @param string[]|null $address_line The origin street address including name and number (when applicable).
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string|null $city Origin city.
     *
     * @return self
     */
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 30)) {
            throw new \InvalidArgumentException('invalid length for $city when calling BillThirdPartyAddress., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling BillThirdPartyAddress., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $state_province_code Origin state code.
     *
     * @return self
     */
    public function setStateProvinceCode($state_province_code)
    {
        ...
        if ((mb_strlen($state_province_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state_province_code when calling BillThirdPartyAddress., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($state_province_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $state_province_code when calling BillThirdPartyAddress., must be bigger than or equal to 2.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 9)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling BillThirdPartyAddress., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($postal_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling BillThirdPartyAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets country_code
     *
     * @param string $country_code Origin country or territory code. Refer to the Supported Country or Territory Tables located in the Appendix.
     *
     * @return self
     */
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling BillThirdPartyAddress., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling BillThirdPartyAddress., must be bigger than or equal to 2.');
        }
