...
/**
 * RatedShipmentRatedPackageRateModifier Class Doc Comment
 *
 * @category Class
 * @package  AntibodiesOnline\UpsApi\Rating
 * @author   OpenAPI Generator team
 ...
 */
class RatedShipmentRatedPackageRateModifier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RatedShipment_RatedPackage_RateModifier';
    ...
    */
    ...
    public function setModifierType($modifier_type)
    {
        ...
        if ((mb_strlen($modifier_type) > 3)) {
            throw new \InvalidArgumentException('invalid length for $modifier_type when calling RatedShipmentRatedPackageRateModifier., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($modifier_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $modifier_type when calling RatedShipmentRatedPackageRateModifier., must be bigger than or equal to 1.');
        }
    ...
    public function setModifierDesc($modifier_desc)
    {
        ...
        if ((mb_strlen($modifier_desc) > 50)) {
            throw new \InvalidArgumentException('invalid length for $modifier_desc when calling RatedShipmentRatedPackageRateModifier., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($modifier_desc) < 1)) {
            throw new \InvalidArgumentException('invalid length for $modifier_desc when calling RatedShipmentRatedPackageRateModifier., must be bigger than or equal to 1.');
        }
    ...
    public function setAmount($amount)
    {
        ...
        if ((mb_strlen($amount) > 16)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling RatedShipmentRatedPackageRateModifier., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($amount) < 1)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling RatedShipmentRatedPackageRateModifier., must be bigger than or equal to 1.');
        }
