...
class NegotiatedChargesItemizedCharges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling NegotiatedChargesItemizedCharges., must be bigger than or equal to 1.');
        }
    ...
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling NegotiatedChargesItemizedCharges., must be bigger than or equal to 1.');
        }
