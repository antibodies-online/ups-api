...
/**
 * RatedShipmentNegotiatedRateChargesItemizedCharges Class Doc Comment
 *
 * @category Class
 * @package  AntibodiesOnline\UpsApi
 * @author   OpenAPI Generator team
 ...
 */
class RatedShipmentNegotiatedRateChargesItemizedCharges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RatedShipment_NegotiatedRateCharges_ItemizedCharges';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling RatedShipmentNegotiatedRateChargesItemizedCharges., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling RatedShipmentNegotiatedRateChargesItemizedCharges., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 50)) {
            throw new \InvalidArgumentException('invalid length for $description when calling RatedShipmentNegotiatedRateChargesItemizedCharges., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling RatedShipmentNegotiatedRateChargesItemizedCharges., must be bigger than or equal to 1.');
        }
    ...
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling RatedShipmentNegotiatedRateChargesItemizedCharges., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling RatedShipmentNegotiatedRateChargesItemizedCharges., must be bigger than or equal to 1.');
        }
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value The value for Itemized Charge costs associated with the shipment.
     *
     * @return self
     */
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 19)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling RatedShipmentNegotiatedRateChargesItemizedCharges., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($monetary_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling RatedShipmentNegotiatedRateChargesItemizedCharges., must be bigger than or equal to 1.');
        }
     ...
     * Sets sub_type
     *
     * @param string|null $sub_type The sub-type of Itemized Charge type.
     *
     * @return self
     */
    public function setSubType($sub_type)
    {
        ...
        if ((mb_strlen($sub_type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $sub_type when calling RatedShipmentNegotiatedRateChargesItemizedCharges., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($sub_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sub_type when calling RatedShipmentNegotiatedRateChargesItemizedCharges., must be bigger than or equal to 1.');
        }
