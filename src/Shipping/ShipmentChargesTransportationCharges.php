...
/**
 * ShipmentChargesTransportationCharges Class Doc Comment
 *
 * @category Class
 ...
 */
class ShipmentChargesTransportationCharges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentCharges_TransportationCharges';
    ...
    */
     ...
     * Sets currency_code
     *
     * @param string $currency_code Transportation charges currency code type. The currency code used in the Shipment request is returned.
     *
     * @return self
     */
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling ShipmentChargesTransportationCharges., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling ShipmentChargesTransportationCharges., must be bigger than or equal to 3.');
        }
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value Transportation and surcharges value amount.  Valid values are from 0 to 99999999999999.99
     *
     * @return self
     */
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 19)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling ShipmentChargesTransportationCharges., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($monetary_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling ShipmentChargesTransportationCharges., must be bigger than or equal to 1.');
        }
