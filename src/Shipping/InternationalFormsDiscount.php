...
/**
 * InternationalFormsDiscount Class Doc Comment
 *
 * @category Class
 ...
 */
class InternationalFormsDiscount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InternationalForms_Discount';
    ...
    */
    ...
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 15)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling InternationalFormsDiscount., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($monetary_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling InternationalFormsDiscount., must be bigger than or equal to 1.');
        }
