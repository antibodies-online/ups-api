...
class NegotiatedRateChargesItemizedCharges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling NegotiatedRateChargesItemizedCharges., must be bigger than or equal to 3.');
        }
    ...
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling NegotiatedRateChargesItemizedCharges., must be bigger than or equal to 3.');
        }
