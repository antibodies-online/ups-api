...
class ShipFromAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $state_province_code Origin locations state or province code.
     *
     * @return self
     */
    public function setStateProvinceCode($state_province_code)
    {
        ...
        if ((mb_strlen($state_province_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $state_province_code when calling ShipFromAddress., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($state_province_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state_province_code when calling ShipFromAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The ship from locations postal code. 9 characters are accepted.
     *
     * @return self
     */
