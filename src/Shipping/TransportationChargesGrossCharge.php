...
/**
 * TransportationChargesGrossCharge Class Doc Comment
 *
 * @category Class
 * @description Gross Charges container. It indicates the shipment level gross Ground Freight Pricing transportation charges.
 * @package  AntibodiesOnline\UpsApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TransportationChargesGrossCharge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransportationCharges_GrossCharge';
    ...
    */
     ...
     * Sets currency_code
     *
     * @param string $currency_code Gross charges currency code.
     *
     * @return self
     */
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling TransportationChargesGrossCharge., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling TransportationChargesGrossCharge., must be bigger than or equal to 3.');
        }
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value Gross charges monetary value.  Valid values are from 0 to 9999999999999999.99
     *
     * @return self
     */
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 19)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling TransportationChargesGrossCharge., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($monetary_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling TransportationChargesGrossCharge., must be bigger than or equal to 1.');
        }
