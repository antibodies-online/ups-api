...
/**
 * TransportationChargesDiscountAmount Class Doc Comment
 *
 * @category Class
 * @description Discount Amount container. It indicates the shipment level Ground Freight Pricing discount amount for transportation charges
 * @package  AntibodiesOnline\UpsApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TransportationChargesDiscountAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransportationCharges_DiscountAmount';
    ...
    */
     ...
     * Sets currency_code
     *
     * @param string $currency_code Discount Amount currency code.
     *
     * @return self
     */
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling TransportationChargesDiscountAmount., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling TransportationChargesDiscountAmount., must be bigger than or equal to 3.');
        }
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value Discount amount monetary value.  Valid values are from 0 to 9999999999999999.99
     *
     * @return self
     */
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 19)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling TransportationChargesDiscountAmount., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($monetary_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling TransportationChargesDiscountAmount., must be bigger than or equal to 1.');
        }
