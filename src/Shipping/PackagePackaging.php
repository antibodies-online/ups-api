 ...
 */
class PackagePackaging implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Package_Packaging';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $code when calling PackagePackaging., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $code when calling PackagePackaging., must be bigger than or equal to 2.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Description of packaging type. Examples are letter, customer supplied, express box.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 35)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PackagePackaging., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PackagePackaging., must be bigger than or equal to 1.');
        }
