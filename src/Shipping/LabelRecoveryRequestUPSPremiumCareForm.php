 ...
 */
class LabelRecoveryRequestUPSPremiumCareForm implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LabelRecoveryRequest_UPSPremiumCareForm';
    ...
    */
    ...
    public function setPageSize($page_size)
    {
        ...
        if ((mb_strlen($page_size) > 2)) {
            throw new \InvalidArgumentException('invalid length for $page_size when calling LabelRecoveryRequestUPSPremiumCareForm., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($page_size) < 2)) {
            throw new \InvalidArgumentException('invalid length for $page_size when calling LabelRecoveryRequestUPSPremiumCareForm., must be bigger than or equal to 2.');
        }
    ...
    public function setPrintType($print_type)
    {
        ...
        if ((mb_strlen($print_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $print_type when calling LabelRecoveryRequestUPSPremiumCareForm., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($print_type) < 2)) {
            throw new \InvalidArgumentException('invalid length for $print_type when calling LabelRecoveryRequestUPSPremiumCareForm., must be bigger than or equal to 2.');
        }
