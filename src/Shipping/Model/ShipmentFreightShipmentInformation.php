 ...
 */
class ShipmentFreightShipmentInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Shipment_FreightShipmentInformation';
    ...
    protected static $openAPITypes = [
        'freight_density_info' => '\AntibodiesOnline\UpsApi\Shipping\Model\FreightShipmentInformationFreightDensityInfo',
    ...
    protected static array $openAPINullables = [
        'freight_density_info' => false,
		'density_eligible_indicator' => false
    ];
    ...
    {
        $this->setIfExists('freight_density_info', $data ?? [], null);
        $this->setIfExists('density_eligible_indicator', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\FreightShipmentInformationFreightDensityInfo|null
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\FreightShipmentInformationFreightDensityInfo|null $freight_density_info freight_density_info
     *
     * @return self
     */
    public function setFreightDensityInfo($freight_density_info)
    {
        if (is_null($freight_density_info)) {
            throw new \InvalidArgumentException('non-nullable freight_density_info cannot be null');
        }
     ...
     *
     * @param string|null $density_eligible_indicator The presence of the tag indicates that the rate request is density based. For Density Based Rating (DBR), the customer must have DBR Contract Service.
     *
     * @return self
     */
    public function setDensityEligibleIndicator($density_eligible_indicator)
    {
        if (is_null($density_eligible_indicator)) {
            throw new \InvalidArgumentException('non-nullable density_eligible_indicator cannot be null');
        }
