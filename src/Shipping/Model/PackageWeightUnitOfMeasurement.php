 ...
 */
class PackageWeightUnitOfMeasurement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PackageWeight_UnitOfMeasurement';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling PackageWeightUnitOfMeasurement., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling PackageWeightUnitOfMeasurement., must be bigger than or equal to 1.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Description of the unit of measurement for package weight.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 35)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PackageWeightUnitOfMeasurement., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PackageWeightUnitOfMeasurement., must be bigger than or equal to 1.');
        }
