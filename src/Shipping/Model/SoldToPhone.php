 ...
 */
class SoldToPhone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SoldTo_Phone';
    ...
    */
     ...
     * Sets number
     *
     * @param string $number Sold To contacts phone number.
     *
     * @return self
     */
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 15)) {
            throw new \InvalidArgumentException('invalid length for $number when calling SoldToPhone., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling SoldToPhone., must be bigger than or equal to 1.');
        }
     ...
     * Sets extension
     *
     * @param string|null $extension Sold To contacts phone extension.
     *
     * @return self
     */
    public function setExtension($extension)
    {
        ...
        if ((mb_strlen($extension) > 4)) {
            throw new \InvalidArgumentException('invalid length for $extension when calling SoldToPhone., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($extension) < 1)) {
            throw new \InvalidArgumentException('invalid length for $extension when calling SoldToPhone., must be bigger than or equal to 1.');
        }
