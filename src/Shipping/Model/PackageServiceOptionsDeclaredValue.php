 ...
 *
 * @category Class
 * @description Container for Declared Value.
 * @package  AntibodiesOnline\UpsApi\Shipping
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PackageServiceOptionsDeclaredValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PackageServiceOptions_DeclaredValue';
    ...
    protected static $openAPITypes = [
        'type' => '\AntibodiesOnline\UpsApi\Shipping\Model\DeclaredValueType',
    ...
    */
     ...
     * Gets type
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\DeclaredValueType|null
     */
     ...
     * Sets type
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\DeclaredValueType|null $type type
     *
     * @return self
     */
     ...
     * Sets currency_code
     *
     * @param string $currency_code Declared value amount currency type. Defaults to the non-Euro currency used in the shippers country or territory.  Code must represent a currency that is a valid for Shipper country or territory.
     *
     * @return self
     */
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling PackageServiceOptionsDeclaredValue., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling PackageServiceOptionsDeclaredValue., must be bigger than or equal to 3.');
        }
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value Declared value amount.
     *
     * @return self
     */
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 19)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling PackageServiceOptionsDeclaredValue., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($monetary_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling PackageServiceOptionsDeclaredValue., must be bigger than or equal to 1.');
        }
