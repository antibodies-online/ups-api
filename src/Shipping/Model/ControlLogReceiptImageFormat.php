 ...
 */
class ControlLogReceiptImageFormat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ControlLogReceipt_ImageFormat';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ControlLogReceiptImageFormat., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ControlLogReceiptImageFormat., must be bigger than or equal to 1.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Description of the image format.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 35)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ControlLogReceiptImageFormat., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ControlLogReceiptImageFormat., must be bigger than or equal to 1.');
        }
