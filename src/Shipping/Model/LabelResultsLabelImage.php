...
/**
 * LabelResultsLabelImage Class Doc Comment
 *
 * @category Class
 ...
 */
class LabelResultsLabelImage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LabelResults_LabelImage';
    ...
    protected static $openAPITypes = [
        'label_image_format' => '\AntibodiesOnline\UpsApi\Shipping\Model\LabelImageLabelImageFormat',
    ...
    */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\LabelImageLabelImageFormat
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\LabelImageLabelImageFormat $label_image_format label_image_format
     *
     * @return self
     */
     ...
     *
     * @param string|null $international_signature_graphic_image Base 64 encoded graphic image of the Warsaw text and signature box.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url This is only returned if the label link is requested to be returned and only at the first package result  Applicable for following types of shipments: Print/Electronic Return Label Print/Electronic Import Control Label Forward shipment except for Mail Innovations Forward
     *
     * @return self
     */
