 ...
 */
class NegotiatedRateChargesTaxCharges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NegotiatedRateCharges_TaxCharges';
    ...
    */
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 9)) {
            throw new \InvalidArgumentException('invalid length for $type when calling NegotiatedRateChargesTaxCharges., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling NegotiatedRateChargesTaxCharges., must be bigger than or equal to 1.');
        }
    ...
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 19)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling NegotiatedRateChargesTaxCharges., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($monetary_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling NegotiatedRateChargesTaxCharges., must be bigger than or equal to 1.');
        }
