 ...
 */
class BillShipperCreditCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillShipper_CreditCard';
    ...
    protected static $openAPITypes = [
        ...
        'address' => '\AntibodiesOnline\UpsApi\Shipping\Model\CreditCardAddress'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['expiration_date']) > 6)) {
            $invalidProperties[] = "invalid value for 'expiration_date', the character length must be smaller than or equal to 6.";
        }

        if ((mb_strlen($this->container['expiration_date']) < 6)) {
            $invalidProperties[] = "invalid value for 'expiration_date', the character length must be bigger than or equal to 6.";
        }
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $type when calling BillShipperCreditCard., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($type) < 2)) {
            throw new \InvalidArgumentException('invalid length for $type when calling BillShipperCreditCard., must be bigger than or equal to 2.');
        }
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 16)) {
            throw new \InvalidArgumentException('invalid length for $number when calling BillShipperCreditCard., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($number) < 9)) {
            throw new \InvalidArgumentException('invalid length for $number when calling BillShipperCreditCard., must be bigger than or equal to 9.');
        }
    ...
    public function setExpirationDate($expiration_date)
    {
        ...
        if ((mb_strlen($expiration_date) > 6)) {
            throw new \InvalidArgumentException('invalid length for $expiration_date when calling BillShipperCreditCard., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($expiration_date) < 6)) {
            throw new \InvalidArgumentException('invalid length for $expiration_date when calling BillShipperCreditCard., must be bigger than or equal to 6.');
        }
    ...
    public function setSecurityCode($security_code)
    {
        ...
        if ((mb_strlen($security_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $security_code when calling BillShipperCreditCard., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($security_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $security_code when calling BillShipperCreditCard., must be bigger than or equal to 3.');
        }
     ...
     * Gets address
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\CreditCardAddress|null
     */
     ...
     * Sets address
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\CreditCardAddress|null $address address
     *
     * @return self
     */
