...
class TransportationChargesNetCharge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets currency_code
     *
     * @param string $currency_code Net Charge currency code.
     *
     * @return self
     */
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value Net charges monetary value.  Valid values are from 0 to 9999999999999999.99
     *
     * @return self
     */
