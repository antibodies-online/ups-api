...
/**
 * HandlingUnitsAdjustedHeight Class Doc Comment
 *
 * @category Class
 ...
 */
class HandlingUnitsAdjustedHeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HandlingUnits_AdjustedHeight';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 19)) {
            throw new \InvalidArgumentException('invalid length for $value when calling HandlingUnitsAdjustedHeight., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling HandlingUnitsAdjustedHeight., must be bigger than or equal to 1.');
        }
