...
class BillReceiverAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The postal code for the UPS accounts pickup address. The pickup postal code was entered in the UPS system when the account was set-up.
     *
     * @return self
     */
