...
/**
 * ForwardAgentAddress Class Doc Comment
 *
 * @category Class
 * @description Address information of the Forwarding agent.  Applicable for EEI form only.
 * @package  AntibodiesOnline\UpsApi\Shipping
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ForwardAgentAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ForwardAgent_Address';
    ...
    */
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 30)) {
            throw new \InvalidArgumentException('invalid length for $city when calling ForwardAgentAddress., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling ForwardAgentAddress., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $state_province_code State of the Forwarding agent.
     *
     * @return self
     */
    public function setStateProvinceCode($state_province_code)
    {
        ...
        if ((mb_strlen($state_province_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $state_province_code when calling ForwardAgentAddress., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($state_province_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state_province_code when calling ForwardAgentAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets town
     *
     * @param string|null $town Town of the Forwarding Agent.
     *
     * @return self
     */
    public function setTown($town)
    {
        ...
        if ((mb_strlen($town) > 30)) {
            throw new \InvalidArgumentException('invalid length for $town when calling ForwardAgentAddress., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($town) < 1)) {
            throw new \InvalidArgumentException('invalid length for $town when calling ForwardAgentAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code Postal code of the Forwarding agent.
     *
     * @return self
     */
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 9)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling ForwardAgentAddress., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($postal_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling ForwardAgentAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling ForwardAgentAddress., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling ForwardAgentAddress., must be bigger than or equal to 2.');
        }
