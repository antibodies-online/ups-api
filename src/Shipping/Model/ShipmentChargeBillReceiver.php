...
/**
 * ShipmentChargeBillReceiver Class Doc Comment
 *
 * @category Class
 ...
 */
class ShipmentChargeBillReceiver implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentCharge_BillReceiver';
    ...
    protected static $openAPITypes = [
        ...
        'address' => '\AntibodiesOnline\UpsApi\Shipping\Model\BillReceiverAddress'
    ];
    ...
    */
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 6)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling ShipmentChargeBillReceiver., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($account_number) < 6)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling ShipmentChargeBillReceiver., must be bigger than or equal to 6.');
        }
     ...
     * Gets address
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\BillReceiverAddress|null
     */
     ...
     * Sets address
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\BillReceiverAddress|null $address address
     *
     * @return self
     */
