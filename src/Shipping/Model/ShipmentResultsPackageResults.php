...
class ShipmentResultsPackageResults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'rate_modifier' => '\AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsRateModifier',
        'base_service_charge' => '\AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsBaseServiceCharge',
        'service_options_charges' => '\AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsServiceOptionsCharges',
        'shipping_label' => '\AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsShippingLabel',
        'shipping_receipt' => '\AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsShippingReceipt',
        'uspspic_number' => 'string',
        'cn22_number' => 'string',
        'accessorial' => '\AntibodiesOnline\UpsApi\Shipping\Model\ShipmentResultsPackageResultsAccessorial',
        'simple_rate' => '\AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsSimpleRate',
        'form' => '\AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsForm',
        'itemized_charges' => '\AntibodiesOnline\UpsApi\Shipping\Model\ShipmentResultsPackageResultsItemizedCharges',
        'negotiated_charges' => '\AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsNegotiatedCharges'
    ];
    ...
    */
    ...
    public function setTrackingNumber($tracking_number)
    {
        ...
        if ((mb_strlen($tracking_number) > 18)) {
            throw new \InvalidArgumentException('invalid length for $tracking_number when calling ShipmentResultsPackageResults., must be smaller than or equal to 18.');
        }
        if ((mb_strlen($tracking_number) < 18)) {
            throw new \InvalidArgumentException('invalid length for $tracking_number when calling ShipmentResultsPackageResults., must be bigger than or equal to 18.');
        }
     ...
     * Gets rate_modifier
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsRateModifier|null
     */
     ...
     * Sets rate_modifier
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsRateModifier|null $rate_modifier rate_modifier
     *
     * @return self
     */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsBaseServiceCharge|null
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsBaseServiceCharge|null $base_service_charge base_service_charge
     *
     * @return self
     */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsServiceOptionsCharges|null
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsServiceOptionsCharges|null $service_options_charges service_options_charges
     *
     * @return self
     */
     ...
     * Gets shipping_label
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsShippingLabel|null
     */
     ...
     * Sets shipping_label
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsShippingLabel|null $shipping_label shipping_label
     *
     * @return self
     */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsShippingReceipt|null
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsShippingReceipt|null $shipping_receipt shipping_receipt
     *
     * @return self
     */
     ...
     * Gets accessorial
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\ShipmentResultsPackageResultsAccessorial|null
     */
     ...
     * Sets accessorial
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\ShipmentResultsPackageResultsAccessorial|null $accessorial accessorial
     *
     * @return self
     */
     ...
     * Gets simple_rate
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsSimpleRate|null
     */
     ...
     * Sets simple_rate
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsSimpleRate|null $simple_rate simple_rate
     *
     * @return self
     */
     ...
     * Gets form
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsForm|null
     */
     ...
     * Sets form
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsForm|null $form form
     *
     * @return self
     */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\ShipmentResultsPackageResultsItemizedCharges|null
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\ShipmentResultsPackageResultsItemizedCharges|null $itemized_charges itemized_charges
     *
     * @return self
     */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsNegotiatedCharges|null
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\PackageResultsNegotiatedCharges|null $negotiated_charges negotiated_charges
     *
     * @return self
     */
