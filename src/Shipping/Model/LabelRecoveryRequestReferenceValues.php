...
class LabelRecoveryRequestReferenceValues implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'reference_number' => '\AntibodiesOnline\UpsApi\Shipping\Model\ReferenceValuesReferenceNumber',
    ...
    */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\ReferenceValuesReferenceNumber
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\ReferenceValuesReferenceNumber $reference_number reference_number
     *
     * @return self
     */
    ...
    public function setShipperNumber($shipper_number)
    {
        ...
        if ((mb_strlen($shipper_number) > 6)) {
            throw new \InvalidArgumentException('invalid length for $shipper_number when calling LabelRecoveryRequestReferenceValues., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($shipper_number) < 6)) {
            throw new \InvalidArgumentException('invalid length for $shipper_number when calling LabelRecoveryRequestReferenceValues., must be bigger than or equal to 6.');
        }
