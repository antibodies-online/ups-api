...
class PackageDimensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'unit_of_measurement' => '\AntibodiesOnline\UpsApi\Shipping\Model\DimensionsUnitOfMeasurement',
        'length' => 'string',
        'width' => 'string',
        'height' => 'string'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['length']) > 3)) {
            $invalidProperties[] = "invalid value for 'length', the character length must be smaller than or equal to 3.";
        }
        ...
        if ((mb_strlen($this->container['width']) > 3)) {
            $invalidProperties[] = "invalid value for 'width', the character length must be smaller than or equal to 3.";
        }
        ...
        if ((mb_strlen($this->container['height']) > 3)) {
            $invalidProperties[] = "invalid value for 'height', the character length must be smaller than or equal to 3.";
        }
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\DimensionsUnitOfMeasurement
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\DimensionsUnitOfMeasurement $unit_of_measurement unit_of_measurement
     *
     * @return self
     */
    ...
    public function setLength($length)
    {
        ...
        if ((mb_strlen($length) > 3)) {
            throw new \InvalidArgumentException('invalid length for $length when calling PackageDimensions., must be smaller than or equal to 3.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if ((mb_strlen($width) > 3)) {
            throw new \InvalidArgumentException('invalid length for $width when calling PackageDimensions., must be smaller than or equal to 3.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if ((mb_strlen($height) > 3)) {
            throw new \InvalidArgumentException('invalid length for $height when calling PackageDimensions., must be smaller than or equal to 3.');
        }
