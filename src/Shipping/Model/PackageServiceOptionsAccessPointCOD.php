 ...
 *
 * @category Class
 * @description Access Point COD indicates Package COD is requested for a shipment.  Valid only for \&quot;01 - Hold For Pickup At UPS Access Point\&quot; Shipment Indication type. Package Access Point COD is valid only for shipment without return service from US/PR to US/PR and CA to CA. Not valid with COD at package level.
 * @package  AntibodiesOnline\UpsApi\Shipping
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
    ...
    */
    ...
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 8)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling PackageServiceOptionsAccessPointCOD., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($monetary_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling PackageServiceOptionsAccessPointCOD., must be bigger than or equal to 1.');
        }
