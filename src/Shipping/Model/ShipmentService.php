...
class ShipmentService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ShipmentService., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ShipmentService., must be bigger than or equal to 2.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Description of the service code. Examples are Next Day Air, Worldwide Express, and Ground.
     *
     * @return self
     */
