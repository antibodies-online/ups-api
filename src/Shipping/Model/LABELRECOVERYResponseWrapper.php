 ...
 */
class LABELRECOVERYResponseWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LABELRECOVERYResponseWrapper';
    ...
    protected static $openAPITypes = [
        'label_recovery_response' => '\AntibodiesOnline\UpsApi\Shipping\Model\LabelRecoveryResponse'
    ];
    ...
    {
        $this->setIfExists('label_recovery_response', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\LabelRecoveryResponse
     */
     ...
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\LabelRecoveryResponse $label_recovery_response label_recovery_response
     *
     * @return self
     */
    public function setLabelRecoveryResponse($label_recovery_response)
    {
        if (is_null($label_recovery_response)) {
            throw new \InvalidArgumentException('non-nullable label_recovery_response cannot be null');
        }
