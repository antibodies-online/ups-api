 ...
 *
 * @category Class
 * @description Delivery Confirmation container.  Refer to Delivery Confirmation Origin- Destination Pairs in the Appendix for a list of valid values.  Valid only for forward shipment only.
 * @package  AntibodiesOnline\UpsApi\Shipping
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PackageServiceOptionsDeliveryConfirmation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PackageServiceOptions_DeliveryConfirmation';
    ...
    */
    ...
    public function setDcisType($dcis_type)
    {
        ...
        if ((mb_strlen($dcis_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $dcis_type when calling PackageServiceOptionsDeliveryConfirmation., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($dcis_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dcis_type when calling PackageServiceOptionsDeliveryConfirmation., must be bigger than or equal to 1.');
        }
    ...
    public function setDcisNumber($dcis_number)
    {
        ...
        if ((mb_strlen($dcis_number) > 11)) {
            throw new \InvalidArgumentException('invalid length for $dcis_number when calling PackageServiceOptionsDeliveryConfirmation., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($dcis_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dcis_number when calling PackageServiceOptionsDeliveryConfirmation., must be bigger than or equal to 1.');
        }
