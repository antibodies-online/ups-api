...
class AlternateDeliveryAddressAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets address_line
     *
     * @param string[] $address_line Address Line of the Retail Location.
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string $city Retail Location City.
     *
     * @return self
     */
     ...
     *
     * @param string|null $state_province_code Retail Location state or province code. Required for US or Canada.
     *
     * @return self
     */
    public function setStateProvinceCode($state_province_code)
    {
        ...
        if ((mb_strlen($state_province_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $state_province_code when calling AlternateDeliveryAddressAddress., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($state_province_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state_province_code when calling AlternateDeliveryAddressAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets country_code
     *
     * @param string $country_code Retail Location country or territory code.
     *
     * @return self
     */
