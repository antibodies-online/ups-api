 ...
 */
class ShipmentShipTo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Shipment_ShipTo';
    ...
    protected static $openAPITypes = [
        ...
        'phone' => '\AntibodiesOnline\UpsApi\Shipping\Model\ShipToPhone',
        'fax_number' => 'string',
        'e_mail_address' => 'string',
        'address' => '\AntibodiesOnline\UpsApi\Shipping\Model\ShipToAddress',
        'location_id' => 'string'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['location_id']) && (mb_strlen($this->container['location_id']) > 10)) {
            $invalidProperties[] = "invalid value for 'location_id', the character length must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['location_id']) && (mb_strlen($this->container['location_id']) < 3)) {
            $invalidProperties[] = "invalid value for 'location_id', the character length must be bigger than or equal to 3.";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ShipmentShipTo., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ShipmentShipTo., must be bigger than or equal to 1.');
        }
     ...
     * Sets attention_name
     *
     * @param string|null $attention_name Contact name at the consignee's location.  Required for: UPS Next Day Air Early service, and when ShipTo country or territory is different than ShipFrom country or territory.   Required if Invoice International form is requested.
     *
     * @return self
     */
    public function setAttentionName($attention_name)
    {
        ...
        if ((mb_strlen($attention_name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $attention_name when calling ShipmentShipTo., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($attention_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $attention_name when calling ShipmentShipTo., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $company_displayable_name Not applicable for ShipTo
     *
     * @return self
     */
    public function setCompanyDisplayableName($company_displayable_name)
    {
        ...
        if ((mb_strlen($company_displayable_name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $company_displayable_name when calling ShipmentShipTo., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($company_displayable_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $company_displayable_name when calling ShipmentShipTo., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $tax_identification_number Consignee's tax identification number.
     *
     * @return self
     */
    public function setTaxIdentificationNumber($tax_identification_number)
    {
        ...
        if ((mb_strlen($tax_identification_number) > 15)) {
            throw new \InvalidArgumentException('invalid length for $tax_identification_number when calling ShipmentShipTo., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($tax_identification_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tax_identification_number when calling ShipmentShipTo., must be bigger than or equal to 1.');
        }
     ...
     * Gets phone
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\ShipToPhone|null
     */
     ...
     * Sets phone
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\ShipToPhone|null $phone phone
     *
     * @return self
     */
     ...
     * Sets fax_number
     *
     * @param string|null $fax_number Consignee's fax number.  If ShipTo country or territory is US 10 digits allowed, otherwise 1-15 digits allowed.
     *
     * @return self
     */
    public function setFaxNumber($fax_number)
    {
        ...
        if ((mb_strlen($fax_number) > 15)) {
            throw new \InvalidArgumentException('invalid length for $fax_number when calling ShipmentShipTo., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($fax_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $fax_number when calling ShipmentShipTo., must be bigger than or equal to 1.');
        }
     ...
     * Sets e_mail_address
     *
     * @param string|null $e_mail_address Consignee's email address.
     *
     * @return self
     */
    public function setEMailAddress($e_mail_address)
    {
        ...
        if ((mb_strlen($e_mail_address) > 50)) {
            throw new \InvalidArgumentException('invalid length for $e_mail_address when calling ShipmentShipTo., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($e_mail_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $e_mail_address when calling ShipmentShipTo., must be bigger than or equal to 1.');
        }
     ...
     * Gets address
     *
     * @return \AntibodiesOnline\UpsApi\Shipping\Model\ShipToAddress
     */
     ...
     * Sets address
     *
     * @param \AntibodiesOnline\UpsApi\Shipping\Model\ShipToAddress $address address
     *
     * @return self
     */
     ...
     * Sets location_id
     *
     * @param string|null $location_id Location ID is a unique identifier referring to a specific shipping/receiving location.  Location ID must be alphanumeric characters. All letters must be capitalized.
     *
     * @return self
     */
    public function setLocationId($location_id)
    {
        ...
        if ((mb_strlen($location_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $location_id when calling ShipmentShipTo., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($location_id) < 3)) {
            throw new \InvalidArgumentException('invalid length for $location_id when calling ShipmentShipTo., must be bigger than or equal to 3.');
        }
