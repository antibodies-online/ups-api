...
/**
 * ProducerPhone Class Doc Comment
 *
 * @category Class
 ...
 */
class ProducerPhone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Producer_Phone';
    ...
    */
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 15)) {
            throw new \InvalidArgumentException('invalid length for $number when calling ProducerPhone., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling ProducerPhone., must be bigger than or equal to 1.');
        }
     ...
     * Sets extension
     *
     * @param string|null $extension The locations phone extension of the Producer.
     *
     * @return self
     */
    public function setExtension($extension)
    {
        ...
        if ((mb_strlen($extension) > 4)) {
            throw new \InvalidArgumentException('invalid length for $extension when calling ProducerPhone., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($extension) < 1)) {
            throw new \InvalidArgumentException('invalid length for $extension when calling ProducerPhone., must be bigger than or equal to 1.');
        }
