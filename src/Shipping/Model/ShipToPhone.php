...
/**
 * ShipToPhone Class Doc Comment
 *
 * @category Class
 * @description Container for Phone Number
 * @package  AntibodiesOnline\UpsApi\Shipping
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ShipToPhone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipTo_Phone';
    ...
    */
     ...
     * Sets number
     *
     * @param string $number Consignee's phone Number.
     *
     * @return self
     */
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 15)) {
            throw new \InvalidArgumentException('invalid length for $number when calling ShipToPhone., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling ShipToPhone., must be bigger than or equal to 1.');
        }
     ...
     * Sets extension
     *
     * @param string|null $extension Consignee's phone extension.
     *
     * @return self
     */
    public function setExtension($extension)
    {
        ...
        if ((mb_strlen($extension) > 4)) {
            throw new \InvalidArgumentException('invalid length for $extension when calling ShipToPhone., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($extension) < 1)) {
            throw new \InvalidArgumentException('invalid length for $extension when calling ShipToPhone., must be bigger than or equal to 1.');
        }
