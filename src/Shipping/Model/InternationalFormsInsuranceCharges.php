 ...
 */
class InternationalFormsInsuranceCharges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InternationalForms_InsuranceCharges';
    ...
    */
    ...
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 15)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling InternationalFormsInsuranceCharges., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($monetary_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling InternationalFormsInsuranceCharges., must be bigger than or equal to 1.');
        }
