...
class UltimateConsigneeAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $state_province_code State of the Ultimate consignee.
     *
     * @return self
     */
    public function setStateProvinceCode($state_province_code)
    {
        ...
        if ((mb_strlen($state_province_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $state_province_code when calling UltimateConsigneeAddress., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($state_province_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state_province_code when calling UltimateConsigneeAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets town
     *
     * @param string|null $town Town of the Ultimate consignee.
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code Postal code of the Ultimate consignee.
     *
     * @return self
     */
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 9)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling UltimateConsigneeAddress., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($postal_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling UltimateConsigneeAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling UltimateConsigneeAddress., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling UltimateConsigneeAddress., must be bigger than or equal to 2.');
        }
