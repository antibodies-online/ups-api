 ...
 */
class LabelRecoveryResponseLabelResults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LabelRecoveryResponse_LabelResults';
    ...
    */
    ...
    public function setTrackingNumber($tracking_number)
    {
        ...
        if ((mb_strlen($tracking_number) > 18)) {
            throw new \InvalidArgumentException('invalid length for $tracking_number when calling LabelRecoveryResponseLabelResults., must be smaller than or equal to 18.');
        }
        if ((mb_strlen($tracking_number) < 18)) {
            throw new \InvalidArgumentException('invalid length for $tracking_number when calling LabelRecoveryResponseLabelResults., must be bigger than or equal to 18.');
        }
    ...
    public function setMailInnovationsTrackingNumber($mail_innovations_tracking_number)
    {
        ...
        if ((mb_strlen($mail_innovations_tracking_number) > 34)) {
            throw new \InvalidArgumentException('invalid length for $mail_innovations_tracking_number when calling LabelRecoveryResponseLabelResults., must be smaller than or equal to 34.');
        }
        if ((mb_strlen($mail_innovations_tracking_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mail_innovations_tracking_number when calling LabelRecoveryResponseLabelResults., must be bigger than or equal to 1.');
        }
