...
/**
 * ShipmentResultsShipmentChargesItemizedCharges Class Doc Comment
 *
 * @category Class
 * @package  AntibodiesOnline\UpsApi\Shipping
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentResultsShipmentChargesItemizedCharges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentResults_ShipmentCharges_ItemizedCharges';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ShipmentResultsShipmentChargesItemizedCharges., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ShipmentResultsShipmentChargesItemizedCharges., must be bigger than or equal to 3.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 50)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ShipmentResultsShipmentChargesItemizedCharges., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ShipmentResultsShipmentChargesItemizedCharges., must be bigger than or equal to 1.');
        }
    ...
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling ShipmentResultsShipmentChargesItemizedCharges., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling ShipmentResultsShipmentChargesItemizedCharges., must be bigger than or equal to 3.');
        }
    ...
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 19)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling ShipmentResultsShipmentChargesItemizedCharges., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($monetary_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling ShipmentResultsShipmentChargesItemizedCharges., must be bigger than or equal to 1.');
        }
    ...
    public function setSubType($sub_type)
    {
        ...
        if ((mb_strlen($sub_type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $sub_type when calling ShipmentResultsShipmentChargesItemizedCharges., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($sub_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sub_type when calling ShipmentResultsShipmentChargesItemizedCharges., must be bigger than or equal to 1.');
        }
