 ...
 */
class NegotiatedRateChargesTotalCharge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NegotiatedRateCharges_TotalCharge';
    ...
    */
     ...
     * Sets currency_code
     *
     * @param string $currency_code Total charges currency code.
     *
     * @return self
     */
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling NegotiatedRateChargesTotalCharge., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling NegotiatedRateChargesTotalCharge., must be bigger than or equal to 3.');
        }
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value Total charges monetary value.  Valid values are from 0 to 9999999999999999.99
     *
     * @return self
     */
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 19)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling NegotiatedRateChargesTotalCharge., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($monetary_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling NegotiatedRateChargesTotalCharge., must be bigger than or equal to 1.');
        }
