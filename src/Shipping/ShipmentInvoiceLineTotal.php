...
class ShipmentInvoiceLineTotal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets currency_code
     *
     * @param string $currency_code Invoice Line Total currency type.
     *
     * @return self
     */
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value Invoice Line Total amount for the entire shipment.  Valid values are from 1 to 99999999.00
     *
     * @return self
     */
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 11)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling ShipmentInvoiceLineTotal., must be smaller than or equal to 11.');
        }
