...
/**
 * SoldToAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class SoldToAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SoldTo_Address';
    ...
    */
     ...
     * Sets city
     *
     * @param string $city SoldTo location's city.
     *
     * @return self
     */
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 30)) {
            throw new \InvalidArgumentException('invalid length for $city when calling SoldToAddress., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling SoldToAddress., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $state_province_code SoldTo location's state or province code.
     *
     * @return self
     */
    public function setStateProvinceCode($state_province_code)
    {
        ...
        if ((mb_strlen($state_province_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $state_province_code when calling SoldToAddress., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($state_province_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state_province_code when calling SoldToAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets town
     *
     * @param string|null $town SoldTo location's town code.
     *
     * @return self
     */
    public function setTown($town)
    {
        ...
        if ((mb_strlen($town) > 30)) {
            throw new \InvalidArgumentException('invalid length for $town when calling SoldToAddress., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($town) < 1)) {
            throw new \InvalidArgumentException('invalid length for $town when calling SoldToAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code SoldTo location's postal code.
     *
     * @return self
     */
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 9)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling SoldToAddress., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($postal_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling SoldToAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets country_code
     *
     * @param string $country_code SoldTo location's country or territory code.
     *
     * @return self
     */
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling SoldToAddress., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling SoldToAddress., must be bigger than or equal to 2.');
        }
