...
/**
 * ScheduleBUnitOfMeasurement Class Doc Comment
 *
 * @category Class
 ...
 */
class ScheduleBUnitOfMeasurement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScheduleB_UnitOfMeasurement';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ScheduleBUnitOfMeasurement., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ScheduleBUnitOfMeasurement., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 20)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ScheduleBUnitOfMeasurement., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ScheduleBUnitOfMeasurement., must be bigger than or equal to 1.');
        }
