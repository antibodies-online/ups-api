...
/**
 * ShipmentChargesServiceOptionsCharges Class Doc Comment
 *
 * @category Class
 ...
 */
class ShipmentChargesServiceOptionsCharges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentCharges_ServiceOptionsCharges';
    ...
    */
    ...
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling ShipmentChargesServiceOptionsCharges., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling ShipmentChargesServiceOptionsCharges., must be bigger than or equal to 3.');
        }
    ...
    public function setMonetaryValue($monetary_value)
    {
        ...
        if ((mb_strlen($monetary_value) > 19)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling ShipmentChargesServiceOptionsCharges., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($monetary_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetary_value when calling ShipmentChargesServiceOptionsCharges., must be bigger than or equal to 1.');
        }
