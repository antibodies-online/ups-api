 ...
 */
class LabelRecoveryRequestLabelDelivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LabelRecoveryRequest_LabelDelivery';
    ...
    protected static array $openAPINullables = [
        'label_link_indicator' => false,
		'resend_e_mail_indicator' => false
    ];
    ...
    {
        $this->setIfExists('label_link_indicator', $data ?? [], null);
        $this->setIfExists('resend_e_mail_indicator', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $label_link_indicator Indicates the Label Recovery and Receipt Recovery URL links are to be returned in the XML Response. Valid for following shipment - Print/Electronic Return Label Print/Electronic Import Control Label Forward shipment except for Mail Innovations Forward
     *
     * @return self
     */
    public function setLabelLinkIndicator($label_link_indicator)
    {
        if (is_null($label_link_indicator)) {
            throw new \InvalidArgumentException('non-nullable label_link_indicator cannot be null');
        }
     ...
     *
     * @param string|null $resend_e_mail_indicator Not Used. If this tag is present, resend the Label Delivery notification email.
     *
     * @return self
     */
    public function setResendEMailIndicator($resend_e_mail_indicator)
    {
        if (is_null($resend_e_mail_indicator)) {
            throw new \InvalidArgumentException('non-nullable resend_e_mail_indicator cannot be null');
        }
